...
namespace Bitmaps {
	const unsigned char food_menu_icon[32] PROGMEM = {
	...
	const unsigned char light_menu_icon[32] PROGMEM = {
	...
	const unsigned char play_menu_icon[32] PROGMEM = {
	...
	const unsigned char medicine_menu_icon[32] PROGMEM = {
	...
	const unsigned char poop_menu_icon[32] PROGMEM = {
	...
	const unsigned char stats_menu_icon[32] PROGMEM = {
	...
	const unsigned char dicipline_menu_icon[32] PROGMEM = {
	...
	const unsigned char attention_menu_icon[32] PROGMEM = {
	...
	const unsigned char* options_list[8] = {
		food_menu_icon,
		light_menu_icon,
		play_menu_icon,
		medicine_menu_icon,
